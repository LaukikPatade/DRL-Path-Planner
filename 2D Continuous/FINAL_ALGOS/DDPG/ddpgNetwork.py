...
class Agent(object):
    def __init__(self, alpha, beta, input_dims, tau,env, epsilon_start=1, epsilon_min=0.1, epsilon_decay=1e-6 , gamma=0.98,
                 n_actions=2, max_size=1000000, layer1_size=400,
                 layer2_size=300, batch_size=64,chkpt_dir='tmp/ddpg_box v4'):
        self.gamma = gamma
        self.tau = tau
    ...
    def choose_action(self, observation):
        ...
        #                          dtype=T.float).to(self.actor.device)*self.epsilon
        # self.actor.train()
